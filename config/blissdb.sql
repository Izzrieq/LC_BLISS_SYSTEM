...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2023 at 05:20 AM
...
--
-- Table structure for table `datalc`
--
...
--
-- Dumping data for table `datalc`
--

INSERT INTO `datalc` (`id`, `stateid`, `bizstype`, `lcid`, `operatorname`, `ownername`, `eduemail`, `kindernohp`) VALUES
(1, 'SEL', 'B', 'LC SEL Jalan Pualam', 'Sabariah Faridah Binti Jamaluddin', 'Sabariah Faridah Binti Jamaluddin', 'k.seksyen7@littlecaliphs.edu.my', '0133625593'),
(2, 'SEL', 'L', 'LC SEL Taman TTDI Jaya', 'T. Jamaliah Binti Tengku Ismail', 'T. Jamaliah Binti Tengku Ismail', 'ttdi jaya@littlecaliphs.edu.my', '0133625593'),
(3, 'SEL', 'L', 'LC SEL Jalan Platinum', 'T. Jamaliah Binti Tengku Ismail', 'T. Jamaliah Binti Tengku Ismail', 'jlnplatinum@littlecaliphs.edu.my', '019-9471707'),
(4, 'SEL', 'L', 'LC SEL Setia Alam', 'T. Jamaliah Binti Tengku Ismail', 'T. Jamaliah Binti Tengku Ismail', 'setiaalam@littlecaliphs.edu.my', '0123852696'),
(5, 'SEL', 'L', 'LC SEL Bandar Seri Putra', 'Waffa Binti A. Rahim', 'Waffa Binti A. Rahim', 'bdrseriputra@littlecaliphs.edu.my', '0192072057'),
(6, 'MLK', 'L', 'LC MLK Sungai Udang', 'Siti Affiza Binti Mohammad', 'Siti Affiza Binti Mohammad', 'sgudang@littlecaliphs.edu.my', '0196008564'),
(7, 'SEL', 'L', 'LC SEL Bandar Puteri, Klang', 'Tadika Prestij Khalifa Sdn Bhd', 'Norizan Binti Abdul Rasid', 'bdrputeri.klang01@littlecaliphs.edu.my', '0123432760');
