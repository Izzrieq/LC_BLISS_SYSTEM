...
<div class="container">
    <br />
    <h3 style="text-align:center; ">PHP Mysql PDO CRUD Server Side Ajax DataTables</h3>   
    <br />
          ...
          <div class="modal-body">
            <form method="post" id="member_form" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <br />
                    <label>DATE/TIME</label>
                    <input type="email" name="cnohp" id="email" class="form-control" />
                    <br /> 
